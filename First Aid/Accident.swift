...
Accident(id: 1, type: "Le Saignement", description: "Lorsque le sang gicle ou coule de façon continue de la plaie, une pression doit être exercée directement sur celle-ci afin d'arrêter le saignement.", title: "Le Saignement", imageName: "saignement", desc: ["Donnez un maximum de 5 claques dans le dos de la victime. Après chaque claque, vérifiez si tout rentre dans l'ordre.", "Si les claques dans le dos n'ont pas d'effet, effectuez un maximum de 5 compressions abdominales.", "Si le problème n'est toujours pas résolu, alternez 5 claques dans le dos et 5 compressions abdominales."], descImage: ["vignette1","vignette2","vignette3"]),
Accident(id: 2, type: "L'Inconscience", description: "Si la victime est inconsciente, et si sa poitrine se soulève régulièrement, il faut libérer les voies aériennes et la placer en position latérale de sécurité.", title: "L'Inconscience", imageName: "inconscience", desc: ["Donnez un maximum de 5 claques dans le dos de la victime. Après chaque claque, vérifiez si tout rentre dans l'ordre.", "Si les claques dans le dos n'ont pas d'effet, effectuez un maximum de 5 compressions abdominales.", "Si le problème n'est toujours pas résolu, alternez 5 claques dans le dos et 5 compressions abdominales."], descImage: ["vignette1","vignette2","vignette3"]),
